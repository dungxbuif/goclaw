...
<p align="center">
Multi-agent AI gateway built in Go. 20+ LLM providers. 8 channels. Multi-tenant PostgreSQL.<br/>
...
- **8 Messaging Channels** — Telegram, Discord, Mezon, Slack, Zalo OA, Zalo Personal, Feishu/Lark, WhatsApp
...
| Channels | — | Telegram, Discord, Mezon, Slack, Zalo, Feishu, WhatsApp |
...
| [Channels](https://docs.goclaw.sh/#channels-overview) | Telegram, Discord, Mezon, Slack, Feishu, Zalo, WhatsApp, WebSocket |
