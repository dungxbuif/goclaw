...
const CHANNEL_TYPES = ["telegram", "discord", "mezon", "slack", "whatsapp", "zalo_oa", "zalo_personal", "feishu", "bitrix24"];
const PERM_CHANNELS = ["telegram", "discord", "mezon", "zalo", "slack", "feishu", "bitrix24"] as const;
